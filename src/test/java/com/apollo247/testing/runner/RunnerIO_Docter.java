...
@CucumberOptions(features = "./src/test/java/com/apollo247/testing/features/FindDocterModule.feature", glue = "com.apollo247.testing.stepdefinitions", dryRun = false, plugin = {
		"pretty", "html:Reports/TestReport.html" }, tags = "@filter"
